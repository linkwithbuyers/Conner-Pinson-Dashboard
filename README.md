# Conner Pinson Dashboard

This is Conner Pinson's read-only campaign dashboard. It never writes to the Google Sheet.

## Publish through GitHub

1. Create a new GitHub repository named `conner-pinson-dashboard`.
...
Conner's shareable Google Sheet is already configured in this copy. Refresh Dashboard always reads the current Sheet data.
